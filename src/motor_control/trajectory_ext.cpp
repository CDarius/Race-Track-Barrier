...
/**
Make a time based or an angle based patch trajectory

:param time_based: True make a time based trajectory. False make and angle based trajectory
:param t0: Start time (us)
:param duration: Maneuver duration in us. User Trajectory.DURATION_FOREVER for infinite duration. Only for time based trajectories
...
/** 
Patch current trajectory to make a new time based trajectory
...
/**
Patch current trajectory to make a new angle based trajectory
